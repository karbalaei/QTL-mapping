...
for (  i in 1 : length(cell_type_names)) {
  ...
  setwd(paste0(dir , "Broad_cell_type/" , cell_type_names[i] , "_data"))
  
  list_base <- grep(list.files(), pattern= paste0(cell_type_names[i], "_broad.cis_qtl_pairs*"), invert=F, value=TRUE)  
