...
sample_mapping = pd.read_csv('astro_sample_mapping_file.csv', dtype={'genotype_individual_id': str, 'phenotype_sample_id': str})
...
def CellRegMap_interaction(gene,anno_df, G, w, W, E , hK , results):
    ...
    df.to_csv('/data/fgoes1/RK/CellRegMap/astro/'+ gene + '_astro_Association.csv',sep=',',index=False)
