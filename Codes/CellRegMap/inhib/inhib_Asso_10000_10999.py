...
sample_mapping = pd.read_csv('inhib_sample_mapping_file.csv', dtype={'genotype_individual_id': str, 'phenotype_sample_id': str})
...
# Cordinates (PCAs)
E_file = 'inhib_CellRegMap_PCAs.txt'
...
#Annotation file
annotation_file = 'inhib_annotation.txt'
...
gene_list2 = gene_list[10000:10999]
...
W= pd.read_csv('inhib_CellRegMap_covariate.txt', index_col=0, sep='	')
...
def CellRegMap_interaction(gene,anno_df, G, w, W, E , hK , results):
    ...
    df.to_csv('/data/fgoes1/RK/CellRegMap/inhib/'+ gene + '_inhib_Association.csv',sep=',',index=False)
